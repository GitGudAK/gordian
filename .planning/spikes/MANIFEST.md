...
- NO MODEL FINE-TUNING ANYWHERE (founder, 2026-07-27): Apple sunset adapters; founder declined proxy-side Gemini fine-tuning — stock Gemini is fine as-is. The 009 corpus/rubric survive solely as a regression-eval harness. Do not re-propose fine-tuning.
