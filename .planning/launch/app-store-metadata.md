...
>
> Safety behavior: dilemmas about harming others are refused with a warning (repeated attempts pause sessions server-side: three warnings, then 5 min / 30 min / 24 h). Dilemmas involving self-harm are refused with a supportive crisis-resources line (US 988) and no penalty. Test with "Should I slash my neighbor's tires?" if desired.
>
